@if (session()->has('message'))
  <div x-data="{ show: true }" x-init="setTimeout(() => show = false, 3000)" x-show="show"
    class="fixed top-10 left-1/2 transform -translate-x-1/2 px-48 py-3"
    role="alert">
    <div class="flex w-96 shadow-lg rounded-lg">
      <div class="bg-laravel py-4 px-6 rounded-l-lg flex items-center">
      ...
      <div
        ...
        <button @click="show = false">
          <svg xmlns="http://www.w3.org/2000/svg"
            class="fill-current text-gray-700" viewBox="0 0 16 16"
            width="20" height="20">
            <path fill-rule="evenodd"
